...
(function () {
  ...
  const STRAVA_REDIRECT_URI_PROD = 'https://jorguitto.github.io/index.html';
  const STRAVA_REDIRECT_URI_DEV = 'https://127.0.0.1:3000/index.html';
  ...
  function getFirebase() {
    ...
    if (!window.auth || !window.db) {
      // En `index.html` existen `auth` y `db` en global scope.
          ...
          window.Swal.fire({
            ...
            html: `
              <div style="text-align:left;font-size:13px">
                ...
                <p style="margin-top:10px">Asegúrate de que exista <code>js/config/strava-config.js</code> (con tu ID numérico) y que en <code>index.html</code> se cargue <b>antes</b> de <code>strava-auth.js</code>. También puedes usar: <code>localStorage.setItem('strava_client_id','TU_ID')</code> y recargar.</p>
              </div>
            `,
          });
        }
