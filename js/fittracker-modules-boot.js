/**
 * Expone APIs ES module al HTML principal (index.html) vía window.__FITTRACKER_MODULES__
 */
...
import {
  STRAVA_CHART_GRANULARITY_KEY,
  readStravaChartGranularity,
  writeStravaChartGranularity,
} from './core/strava-chart-granularity.js';
import { applyStravaCatalogToBioMaxes } from './core/strava-bio-max-sync.js';
