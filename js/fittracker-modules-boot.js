...
import { buildAiCoachContextSummary } from './core/ai-coach-context.js';
import { testAiCoachConnection, requestAiCoachCompletion } from './services/ai-coach-client.js';
...
window.__FITTRACKER_MODULES__ = {
  ...
  testAiCoachConnection,
  requestAiCoachCompletion,
};
